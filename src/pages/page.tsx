...
// Melhoria: Definição de tipos para os dados do módulo para garantir type safety.
interface Example {
    formalPhrase: string;
...
interface Exercise {
    id: string;
    type: 'listen_repeat' | 'multiple_choice';
    text?: string;
    question?: string;
    options?: string[];
...
interface ModuleViewProps {
    module: { title: string; description: string; examples: Example[]; exercises: Exercise[] };
